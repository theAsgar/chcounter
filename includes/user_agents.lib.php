 ...
 **************************************
 *
 * Info: die Groß-/Kleinschreibung muss richtig angegeben werden!
*/
...
$chC_ualib_browsers = array(
	...
	'Firefox' => array(
		 'icon' => 'firefox.png',
		'use_PCRE' => 1,
		'pattern' => '#(Firefox|Firebird|Phoenix|BonEcho|GranParadiso)/([0-9.]+)#i',
		'version' => 2,
		'anti_pattern' => '/(Flock)/i'
	),
	'Mozilla' => array(
		'icon' => 'mozilla.png',
		'use_PCRE' => 1,
		...
		'version' => 2,
		'anti_pattern' => '/(Netscape|Galeon|K-Meleon|Epiphany|Camino|Chimera|Firefox|Firebird|Phoenix|Beonex|SeaMonkey|Flock|Iceweasel)/i'
	),
	'Opera' => array(
		'icon' => 'opera.png',
		'use_PCRE' => 1,
