...
$_CHC_DBCONFIG = array(
	...
	'user' => 'xxxx',			// database account | Benutzername | mot d'utilisateur
	'password' => 'xxxx',			// database password | Passwort | mot de passe
	'database' => 'xxxx',			// database name | Datenbankname | nom de la base de données
